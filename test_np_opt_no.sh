echo "Test support 0.05 without partition or min code optimization" > /home/liliang/fsmhg_test/sta_sup5_np_opt_no.log
echo "No optimization" >> /home/liliang/fsmhg_test/sta_sup5_np_opt_no.log
