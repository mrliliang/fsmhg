...
//         System.out.println(dfsCode.minCode());
        ...
        TransLoader loader = new TransLoader(new File("/home/liliang/data/as-733-snapshots-ogirinal"));
        ...
        System.out.println("Average snapshots per cluster " + (733 / clusters.size()));
        int oneCount = 0;
